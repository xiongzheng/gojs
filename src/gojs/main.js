...
define(["dojox/gfx", "dojo/_base/lang", "dojo/dom"], function(gfx, lang, dom) {
  var Board, GoBoard;
  Board = (function() {
    ...
    function GoBoard(container, container_size, board_size) {
      ...
      */
      ...
      handle_click = function(shape, evt) {
        var circle, coord_x, coord_y, x_1, y_1;
      ...
      while (index < board_size) {
        ...
        while (j < board_size) {
          ...
          click = click_detect_group.createRect({
            ...
            width: cell_radius,
            height: cell_radius
          }).setFill([0, 0, 255, 0.5]).moveToFront();
